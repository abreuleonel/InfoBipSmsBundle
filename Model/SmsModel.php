...
namespace MauticPlugin\InfoBipSmsBundle\Model;
...
use MauticPlugin\InfoBipSmsBundle\Api\SmsInfoBipApi;
...
class SmsModel extends FormModel implements AjaxLookupModelInterface
{
     ...
     */
    public function __construct(TrackableModel $pageTrackableModel, LeadModel $leadModel, MessageQueueModel $messageQueueModel, SmsInfoBipApi $smsApi)
    {
